<nav x-data="{ open: false }" class="bg-beige border-b border-gray-100 shadow-xl">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{asset('/icons/logo.png')}}" alt="Ваш логотип" class="block h-9 w-auto">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-green">
