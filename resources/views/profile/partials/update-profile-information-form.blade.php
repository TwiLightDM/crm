<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="surname" name="surname" type="text" class="block w-full mt-1" :value="old('surname', $user->surname)" required autofocus autocomplete="surname" />
        ...
        <div>
            ...
            <x-text-input id="patronymic" name="patronymic" type="text" class="block w-full mt-1" :value="old('patronymic', $user->patronymic)" autofocus autocomplete="patronymic" />
